  ...
  return (
    <>
      ...
      >
        ...
        <Link to="/" className={s.logoLink} aria-label="Sarah Cambra — home">
          {!logoError ? (
            <img
        ...
        <div className={s.right}>
          ...
          <div className={s.extrasDesktop}>
            <button
              onClick={toggle}
              className={[s.themeToggle, dark ? s.themeToggleDark : ''].filter(Boolean).join(' ')}
              aria-label={dark ? 'Switch to light mode' : 'Switch to dark mode'}
            >
              {dark ? <SunIcon /> : <MoonIcon />}
            </button>

            {/* FIX: "Chat" was too vague — changed to "Let's Talk"
                and added aria-label for screen readers */}
            <Link
              to="/about#contact"
              className={[s.cta, dark ? s.ctaDark : ''].filter(Boolean).join(' ')}
              aria-label="Get in touch with Sarah"
            >
              Let's Talk
            </Link>
          </div>
      ...
      >
        <div className={s.drawerContent}>
          ...
          <div className={s.drawerSeparator} aria-hidden="true" />
